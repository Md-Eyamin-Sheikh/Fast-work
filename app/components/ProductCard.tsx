  ...
  return (
    <div className="group bg-white rounded-xl md:rounded-2xl border border-gray-200 hover:border-blue-300 hover:shadow-2xl transition-all duration-300 overflow-hidden">
      ...
      <div className="p-3 md:p-4 lg:p-5">
        <h3 className="font-bold text-xl md:text-base lg:text-lg mb-1 line-clamp-2 text-gray-900 group-hover:text-blue-600 transition-colors leading-tight">
          {product.name}
        </h3>
        <p className="text-sm text-gray-500 font-medium my-2">{product.description}</p>
